 ...
 */
public class Fim3Activity extends AppCompatActivity {
    ...
    public void ouvidoesquerdo(View view) {
        Intent intent = new Intent(Fim3Activity.this, OuvidoEsquerdo500Activity.class);
