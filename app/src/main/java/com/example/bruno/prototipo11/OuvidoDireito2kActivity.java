 ...
 */
public class OuvidoDireito2kActivity extends AppCompatActivity{
    ...
    private void mandarResultado(){
        ...
        switch (dB){
            ...
            case 3:
                ...
                break;
            case 4:
                intent.putExtra("result2", "20");
                break;
            case 5:
                intent.putExtra("result2", "30");
                break;
            case 6:
                intent.putExtra("result2", "40");
                break;
            case 7:
                intent.putExtra("result2", "50");
                break;
            case 8:
                intent.putExtra("result2", "60");
                break;
            case 9:
                intent.putExtra("result2", "70");
                break;
            case 10:
                intent.putExtra("result2", "80");
                break;
        }
