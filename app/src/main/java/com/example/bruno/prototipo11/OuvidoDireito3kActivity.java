 ...
 */
public class OuvidoDireito3kActivity extends AppCompatActivity {
    ...
    private void mandarResultado(){
        ...
        Intent intent = new Intent(this,OuvidoDireito4kActivity.class);
        ...
        switch (dB){
            case 1:
                intent.putExtra("result3", "-10");
                break;
            case 2:
                intent.putExtra("result3", "0");
                break;
            case 3:
                intent.putExtra("result3", "10");
                break;
            case 4:
                intent.putExtra("result3", "20");
                break;
            case 5:
                intent.putExtra("result3", "30");
                break;
            case 6:
                intent.putExtra("result3", "40");
                break;
            case 7:
                intent.putExtra("result3", "50");
                break;
            case 8:
                intent.putExtra("result3", "60");
                break;
            case 9:
                intent.putExtra("result3", "70");
                break;
            case 10:
                intent.putExtra("result3", "80");
                break;
        }
