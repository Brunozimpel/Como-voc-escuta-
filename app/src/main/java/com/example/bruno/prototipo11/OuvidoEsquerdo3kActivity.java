 ...
 */
public class OuvidoEsquerdo3kActivity extends AppCompatActivity {
    ...
    private void mandarResultado(){
        ...
        switch (dB){
            case 1:
                intent.putExtra("result30", "-10");
                break;
            case 2:
                intent.putExtra("result30", "0");
                break;
            case 3:
                intent.putExtra("result30", "10");
                break;
            case 4:
                intent.putExtra("result30", "20");
                break;
            case 5:
                intent.putExtra("result30", "30");
                break;
            case 6:
                intent.putExtra("result30", "40");
                break;
            case 7:
                intent.putExtra("result30", "50");
                break;
            case 8:
                intent.putExtra("result30", "60");
                break;
            case 9:
                intent.putExtra("result30", "70");
                break;
            case 10:
                intent.putExtra("result30", "80");
                break;
        }
